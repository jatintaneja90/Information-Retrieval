    ...
    for query_id in query_file_dict:
        ...
        for doc in normalised_tf_dict:
            ...
            for term in query.split():
                #print term, unigram_doc_table[term],doc,normalised_tf_dict[doc][term]
        ...
        file_handler.print_ranked_doc(ranked_list, query_id, "tf-idf_System", "../tf-idf output/"+"Q"+str(query_id)+"_tf-idf_score.txt")
        #doc_weight_score=0
