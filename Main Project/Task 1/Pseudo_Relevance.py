...
for query_id in query_file_dict:
    ...
    bm25_score_list = Query_Processor.process_query_with_relevance(query_suggest)
    print bm25_score_list
    file_handler.print_ranked_doc(bm25_score_list, query_id, "PseudoRel_BM25_System",
                                  "../Pseudo output_3w10d/Q" + query_id + "pseudo_rel_result.txt")
